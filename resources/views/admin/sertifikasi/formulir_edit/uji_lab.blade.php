...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="campuranVarietasLain-{{ $Sertifikasi->id }}"
                name="campuran_varietas_lain" required>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="mb-3">
            <label for="volume" class="form-label">Volume</label>
            <input type="number" class="form-control" id="volume-{{ $Sertifikasi->id }}" name="volume" required>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="mb-3">
            <label for="kadarAir" class="form-label">Kadar Air</label>
            <input type="number" class="form-control" id="kadarAir-{{ $Sertifikasi->id }}" name="kadar_air" required>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="mb-3">
            <label for="benihMurni" class="form-label">Benih Murni</label>
            <input type="number" class="form-control" id="benihMurni-{{ $Sertifikasi->id }}" name="benih_murni"
                required>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="kotoranBenih-{{ $Sertifikasi->id }}" name="kotoran_benih"
                required>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="dayaBerkecambah-{{ $Sertifikasi->id }}"
                name="daya_berkecambah" required>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="mb-3">
            <label for="kesehatanBenih" class="form-label">Kesehatan Benih</label>
            <input type="number" class="form-control" id="kesehatanBenih-{{ $Sertifikasi->id }}"
                name="kesehatan_benih" required>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="mb-3">
            <label for="bijiGulma" class="form-label">Biji Gulma</label>
            <input type="number" class="form-control" id="bijiGulma-{{ $Sertifikasi->id }}" name="biji_gulma"
                required>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
